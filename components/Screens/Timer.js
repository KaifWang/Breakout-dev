...
const Timer = ({navigation}) => {
  ...
  return(
    <View style={styles.header}>
      ...
      >
      <ImageBackground style={styles.PopUpImage} source = {require('../../src/Timer/PopUpWindow/Alert.png')}>
        <TouchableHighlight
          onPress={() => {
            setModalVisible(!modalVisible);
          }}
        >
          <Image style={styles.PopUpButtonImage} source = {require('../../src/Timer/PopUpWindow/OK.png')}></Image>
        </TouchableHighlight>
      </ImageBackground>
